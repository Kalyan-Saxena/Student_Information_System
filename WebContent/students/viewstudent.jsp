...
<section >
  <div class="container" style="border:2px solid white;background-color:rgba(0,0,0,0.5);padding:30px; margin:100px;">
    <h1 align="center"  class="mt-3 mb-5"> View Student Details</h1>
    <form class="col-lg-4 mx-auto " action="viewstd.jsp" method="post" >
      <div class="form-group">
        <input type="text" name="stdreg" class="form-control my-3" placeholder="Enter Student Registration" required>
        
      </div>
     
        <button type="submit" class="btn btn-outline-info" style="margin-left:35%;" name="button">Search</button>
