...
<section>
  <div class="container">
    <h1 align="center"  class="mt-3 mb-5"> Student Semister-1 Details</h1>
...
try{
	...
	String sql = "select * from semister1marks where StdReg=?";
	...
	%>
          ...
          <tr>
            ...
            <td><%= rs.getString("Sub1Internal") %></td>
            <td><%= rs.getString("Sub1External") %></td>
          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject2") %></th>
            <td><%= rs.getString("Sub2Internal") %></td>
            <td><%= rs.getString("Sub2External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject3") %></th>
            <td><%= rs.getString("Sub3Internal") %></td>
            <td><%= rs.getString("Sub3External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject4") %></th>
            <td><%= rs.getString("Sub4Internal") %></td>
            <td><%= rs.getString("Sub4External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject5") %></th>
            <td><%= rs.getString("Sub5Internal") %></td>
            <td><%= rs.getString("Sub5External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject6") %></th>
            <td><%= rs.getString("Sub6Internal") %></td>
            <td><%= rs.getString("Sub6External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject7") %></th>
            <td><%= rs.getString("Sub7Internal") %></td>
            <td><%= rs.getString("Sub7External") %></td>

          </tr>
          <tr>
            <th scope="row"><%= rs.getString("Subject8") %></th>
            <td><%= rs.getString("Sub8Internal") %></td>
            <td><%= rs.getString("Sub8External") %></td>
...
<a href="viewmarks.jsp" style="margin-left:50%;" class="btn btn-info">Back</a>
