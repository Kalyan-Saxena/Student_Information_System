      ...
      <div class="row">
        <nav class="navbar navbar-expand-xs navbar-dark bg-inverse mx-auto" >
            ...
            <div class="collapse navbar-collapse" id="student-related">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active mx-2">
                  <a class="nav-link " href="viewstudent.jsp">View Student <span class="sr-only">(current)</span></a>
                </li>
      ...
      <div class="row">
        <nav class="navbar navbar-expand-xs navbar-dark bg-inverse mx-auto" >
            ...
            <div class="collapse navbar-collapse" id="marks-related">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active mx-2">
                  <a class="nav-link " href="viewmarks.jsp">View  Marks <span class="sr-only">(current)</span></a>
                </li>
      ...
      <div class="row">
        <nav class="navbar navbar-expand-xs navbar-dark bg-inverse mx-auto" >
            ...
            <div class="collapse navbar-collapse" id="attendance-related">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active mx-2">
                  <a class="nav-link " href="viewatten.jsp">View Attendance <span class="sr-only">(current)</span></a>
                </li>
