...
try{
	...
	String sql = "update sem8attendance set StdReg=?,Subject1=?,Sub1TP=?,Subject2=?,Sub2TP=?,Subject3=?,Sub3TP=?,Subject4=?,Sub4TP=?,Subject5=?,Sub5TP=?,Subject6=?,Sub6TP=?,Subject7=?,Sub7TP=?,Subject8=?,Sub8TP=?  where StdReg=?";
	...
	alert("Semister-8 Attendance added successfully");
