...
try{
	...
	String sql ="insert into sem6attendance (StdReg,Subject1,Sub1TP,Subject2,Sub2TP,Subject3,Sub3TP,Subject4,Sub4TP,Subject5,Sub5TP,Subject6,Sub6TP,Subject7,Sub7TP,Subject8,Sub8TP) values(?,'null','null','null','null','null','null','null','null','null','null','null','null','null','null','null','null')";
...
try{
	...
	String sql = "update sem6attendance set StdReg=?,Subject1=?,Sub1TP=?,Subject2=?,Sub2TP=?,Subject3=?,Sub3TP=?,Subject4=?,Sub4TP=?,Subject5=?,Sub5TP=?,Subject6=?,Sub6TP=?,Subject7=?,Sub7TP=?,Subject8=?,Sub8TP=?  where StdReg=?";
	...
	alert("Semister-6 Attendance added successfully");
