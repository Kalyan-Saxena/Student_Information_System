...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 align="center" class="my-3" >Semister-1 Attendance</h1><hr>

      <form action="addsem1attend.jsp"  method="post" >
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="form-group row ">
              ...
              <select class=" col-sm-5 form-control mx-3"  id="sub" name="subj1" required>
                <option selected value="" disabled>Subject</option>
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s1p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s2p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s3p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
           ...
           <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s4p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
          ...
          <div class="col-lg-6">
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s5p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
           ...
           <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s6p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s7p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row ">
              <label for="internal" class="col-sm-2 col-form-label">Total(%):</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="internal" name="s8p" placeholder="Total Percentage" required>
              </div>
            </div>
            <hr>
