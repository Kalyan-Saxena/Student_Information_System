...
<section style="margin-top:10%;" >
  <div class="container py-5" style="background-color:rgba(0,0,0,0.5); border:2px solid white; ">
    <h1 align="center"  class="mt-3 mb-5"><i> Delete Student Marks </i></h1>

    <div class="container" style="margin-left:5%;">

    <a href="delsem1marks.jsp" class="btn  btn-outline-info mx-2">Semister-1</a>
    <a href="delsem2marks.jsp" class="btn  btn-outline-info mx-2">Semister-2</a>
    <a href="delsem3marks.jsp" class="btn  btn-outline-info mx-2">Semister-3</a>
    <a href="delsem4marks.jsp" class="btn  btn-outline-info mx-2">Semister-4</a>
    <a href="delsem5marks.jsp" class="btn  btn-outline-info mx-2">Semister-5</a>
    <a href="delsem6marks.jsp" class="btn  btn-outline-info mx-2">Semister-6</a>
    <a href="delsem7marks.jsp" class="btn  btn-outline-info mx-2">Semister-7</a>
    <a href="delsem8marks.jsp" class="btn  btn-outline-info mx-2">Semister-8</a>
