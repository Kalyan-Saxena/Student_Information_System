...
<section style="margin-top:10%;" >
  <div class="container py-5" style="background-color:rgba(0,0,0,0.5); border:2px solid white; ">
    <h1 align="center"  class="mt-3 mb-5"><i> Add Student Attendance </i></h1>

    <div class="container" style="margin-left:5%;">

    <a href="addsem1attendance.jsp" class="btn  btn-outline-info mx-2">Semister-1</a>
    <a href="addsem2attendance.jsp" class="btn  btn-outline-info mx-2">Semister-2</a>
    <a href="addsem3attendance.jsp" class="btn  btn-outline-info mx-2">Semister-3</a>
    <a href="addsem4attendance.jsp" class="btn  btn-outline-info mx-2">Semister-4</a>
    <a href="addsem5attendance.jsp" class="btn  btn-outline-info mx-2">Semister-5</a>
    <a href="addsem6attendance.jsp" class="btn  btn-outline-info mx-2">Semister-6</a>
    <a href="addsem7attendance.jsp" class="btn  btn-outline-info mx-2">Semister-7</a>
    <a href="addsem8attendance.jsp" class="btn  btn-outline-info mx-2">Semister-8</a>
