...
<section>
  <div class="container" >
    ...
    <form class="col-lg-4 mx-auto" action="delstd.jsp" method="post" style="border:2px solid white;background-color:rgba(0,0,0,0.5); padding:30px;  margin:50px;">
    <h1 align="center" style="margin-top:10%;" class="mb-5"> Delete Student</h1>
      <div class="form-group">
        <input type="text" name="stdreg" class="form-control my-3" placeholder="Enter Student Registration" required>
        <button type="submit" name="submit"  class="btn btn-outline-info my-3" style="margin-left:37%;">Delete</button>
      </div>
    </form>
