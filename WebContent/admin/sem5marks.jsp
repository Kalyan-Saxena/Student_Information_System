...
try{
	...
	String sql = "insert into semister5marks " + " (StdReg,Subject1,Sub1Internal,Sub1External,Subject2,Sub2Internal,Sub2External,Subject3,Sub3Internal,Sub3External,Subject4,Sub4Internal,Sub4External,Subject5,Sub5Internal,Sub5External,Subject6,Sub6Internal,Sub6External,Subject7,Sub7Internal,Sub7External,Subject8,Sub8Internal,Sub8External)"+ " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	alert("Semister-5 marks added successfully");
